        ...
        64626: function(e, r, n) {
            ...
            var m = function e(r) {
                ...
                return k.clone = e, k.ROUND_UP = 0, k.ROUND_DOWN = 1, k.ROUND_CEIL = 2, k.ROUND_FLOOR = 3, k.ROUND_HALF_UP = 4, k.ROUND_HALF_DOWN = 5, k.ROUND_HALF_EVEN = 6, k.ROUND_HALF_CEIL = 7, k.ROUND_HALF_FLOOR = 8, k.EUCLID = 9, k.config = k.set = function(e) {
                    ...
                    if (null != e) {
                        if ("object" == typeof e) {
                            ...
                            if (e.hasOwnProperty(r = "CRYPTO")) {
                                if (!!(n = e[r]) === n) {
                                    if (n) {
                                        if ("undefined" != typeof crypto && crypto && (crypto.getRandomValues || crypto.randomBytes)) x = n;
                                        else throw x = !n, Error(o + "crypto unavailable")
                                    } else x = n
                                } else throw Error(o + r + " not true or false: " + n)
                            }
                            if (e.hasOwnProperty(r = "MODULO_MODE") && (h(n = e[r], 0, 9, r), U = n), e.hasOwnProperty(r = "POW_PRECISION") && (h(n = e[r], 0, 1e9, r), C = n), e.hasOwnProperty(r = "FORMAT")) {
                    ...
                    var n, t;
                    return (e = new k(e, r), this.c && e.s && (!e.c || e.c[0])) ? e.c && (!this.c || this.c[0]) ? (9 == U ? (t = e.s, e.s = 1, n = b(this, e, 0, 3), e.s = t, n.s *= t) : n = b(this, e, 0, U), (e = this.minus(n.times(e))).c[0] || 1 != U || (e.s = this.s), e) : new k(this) : new k(NaN)
                    ...
                    if (0 == (o = Math.sqrt(+$(this))) || o == 1 / 0 ? (((r = c(s)).length + u) % 2 == 0 && (r += "0"), o = Math.sqrt(+r), u = l((u + 1) / 2) - (u < 0 || u % 2), r = o == 1 / 0 ? "5e" + u : (r = o.toExponential()).slice(0, r.indexOf("e") + 1) + u, n = new k(r)) : n = new k(o + ""), n.c[0]) {
                        for ((o = (u = n.e) + f) < 3 && (o = 0);;)
